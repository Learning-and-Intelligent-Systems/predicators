...
def test_random_options_approach():
    ...
    assert str(actions) == "[Action(_arr=array([0.6823519], dtype=float32), extra_info=None), Action(_arr=array([0.8120945], dtype=float32), extra_info=None), Action(_arr=array([0.92334497], dtype=float32), extra_info=None), Action(_arr=array([0.2765744], dtype=float32), extra_info=None), Action(_arr=array([0.81975454], dtype=float32), extra_info=None), Action(_arr=array([0.8898927], dtype=float32), extra_info=None), Action(_arr=array([0.51297045], dtype=float32), extra_info=None), Action(_arr=array([0.8242416], dtype=float32), extra_info=None), Action(_arr=array([0.74146706], dtype=float32), extra_info=None), Action(_arr=array([0.6299402], dtype=float32), extra_info=None)]"  # pylint: disable=line-too-long
