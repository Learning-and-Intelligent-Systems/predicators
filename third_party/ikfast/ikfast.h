...
// Update 2022-06-04: newer OS installations don't have Python 2.7 installed
// by default so including this line breaks things. Removing it doesn't seem
// to break anything so let's leave it out.
