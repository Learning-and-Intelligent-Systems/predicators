...
PLOT_GROUPS = {
    "Stick Button": [
        ...
        ("Ours (Nonparam)", "o",
         lambda df: df["EXPERIMENT_ID"].apply(lambda v: "direct_bc_nonparam_" in v)),
        ("GNN Metacontroller (Param)", "o",
         lambda df: df["EXPERIMENT_ID"].apply(lambda v: "gnn_metacontroller_param_" in v)),
        ("GNN Metacontroller (Nonparam)", "o",
         lambda df: df["EXPERIMENT_ID"].apply(lambda v: "gnn_metacontroller_nonparam_" in v)),
        ("GNN Action Policy", "o",
         lambda df: df["EXPERIMENT_ID"].apply(lambda v: "gnn_action_policy_" in v)),
        ("Max Skeletons=1", "o",
         lambda df: df["EXPERIMENT_ID"].apply(lambda v: "direct_bc_max_skel1_" in v)),
        ("Max Samples=1", "o",
         lambda df: df["EXPERIMENT_ID"].apply(lambda v: "direct_bc_max_samp1_" in v)),
    ],
}
