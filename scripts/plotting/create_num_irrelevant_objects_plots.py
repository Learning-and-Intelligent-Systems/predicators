"""Create plots for learning from varying numbers of irrelevant objects."""
...
COLUMN_NAMES_AND_KEYS = [
    ...
    ("NUM_IRRELEVANT", "irrelevant_objs"),
]

DERIVED_KEYS = [("perc_solved",
                 lambda r: 100 * r["num_solved"] / r["num_test_tasks"]),
                 ("irrelevant_objs",
                 lambda r: int(r["experiment_id"].split("irrelevant_")[-1]))]
...
X_KEY_AND_LABEL = [
    ("NUM_IRRELEVANT", "Number of Irrelevant Objects"),
