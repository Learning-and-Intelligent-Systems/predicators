"""Create plots for learning from varying numbers of irrelevant predicates."""
...
COLUMN_NAMES_AND_KEYS = [
    ...
    ("NUM_IRRELEVANT_STATIC", "cover_num_irrelevant_static_preds"),
    ("NUM_IRRELEVANT_DYNAMIC", "cover_num_irrelevant_dynamic_preds"),
    ("NUM_IRRELEVANT_RANDOM", "cover_num_irrelevant_random_preds"),
]
...
X_KEY_AND_LABEL = [
    ("NUM_IRRELEVANT_STATIC", "# Irrelevant Static Predicates"),
    # ("NUM_IRRELEVANT_DYNAMIC", "# Irrelevant Dynamic Predicates"),
    # ("NUM_IRRELEVANT_RANDOM", "# Irrelevant Random Predicates"),
...
Y_KEY_AND_LABEL = [
    ...
    ("AVG_NODES_CREATED", "Average Nodes Created"),
    ("AVG_TEST_TIME", "Average Test Time (s)"),
]
...
PLOT_GROUPS = {
    "Irrelevant Static Predicates": [
        ("Cover", "o",
         lambda df: df["EXPERIMENT_ID"].apply(lambda v: "_irrelevant_static_" in v)),
    ],
    # "Irrelevant Dynamic Predicates": [
    #     ("Cover", "o",
    #      lambda df: df["EXPERIMENT_ID"].apply(lambda v: "_irrelevant_dynamic_" in v)),
    # ],
    # "Irrelevant Random Predicates": [
    #     ("Cover", "o",
    #      lambda df: df["EXPERIMENT_ID"].apply(lambda v: "_irrelevant_random_" in v)),
    # ],
}
