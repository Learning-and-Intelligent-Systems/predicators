...
for ENV in ${ALL_ENVS[@]}; do
    # Main approach.
    python $FILE --experiment_id ${ENV}_main_${NUM_TRAIN_TASKS}demo --env $ENV --approach grammar_search_invention --excluded_predicates all --num_train_tasks $NUM_TRAIN_TASKS --grammar_search_predicate_labelling_noise_prob 0.01 --debug --grammar_search_use_handcoded_debug_grammar False --disable_harmlessness_check True --cluster_and_intersect_min_datastore_fraction 0.1
