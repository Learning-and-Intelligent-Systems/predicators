...
for SEED in $(seq $START_SEED $((NUM_SEEDS+START_SEED-1))); do
    ...
    python $FILE --experiment_id rnt_harmlessness_check --env repeated_nextto --approach nsrt_learning --side_predicate_learner preserve_skeletons_hill_climbing --seed $SEED --num_train_tasks 50
