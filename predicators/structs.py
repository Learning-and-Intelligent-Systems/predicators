...
class Type:
    ...
    def __hash__(self) -> int:
        return hashlib.sha1(str((self.name, tuple(self.feature_names))).encode('utf-8').tobytes(), usedforsecurity=False)
...
class _TypedEntity:
    ...
    @cached_property
    def _hash(self) -> int:
        return hashlib.sha1(str(self).encode('utf-8').tobytes(), usedforsecurity=False)
