"""Policy-guided planning for generalized policy generation (PG3) with an initialized policy.
...
class InitializedPG3Approach(PG3Approach):
    """Policy-guided planning for generalized policy generation (PG3) with initialized policy."""
    ...
    def _get_policy_search_initial_ldl() -> LiftedDecisionList:
        # Initialize with intialized policy frmo file. 
