...
from predicators.behavior_utils.motion_planner_fns import make_grasp_plan, \
    make_navigation_plan, make_placeontop_plan, make_dummy_plan
from predicators.behavior_utils.option_fns import create_grasp_policy, \
    create_navigate_policy, create_place_policy, create_dummy_policy
...
class BehaviorEnv(BaseEnv):
    ...
    def set_options(self) -> None:
        ...
        planner_fns: List[Callable[[
            ...
            make_navigation_plan, make_grasp_plan, make_placeontop_plan, make_dummy_plan
        ]
        ...
        option_model_fns: List[
            Callable[[List[List[float]], List[List[float]], "URDFObject"],
                     Callable[[State, "behavior_env.BehaviorEnv"], None]]] = [
                         ...
                         create_grasp_option_model, create_place_option_model, create_open_option_model
                     ]
