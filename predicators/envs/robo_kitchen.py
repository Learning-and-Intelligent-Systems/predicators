...
class RoboKitchenEnv(BaseEnv):
    ...
    rich_object_type = Type("rich_object_type", ["x", "y", "z", "qx", "qy", "qz"])
    ...
    def __init__(self, use_gui: bool = True) -> None:
        ...
        self.all_geoms = self._env.sim.model.geom_names
        print(f"All geoms: {self.all_geoms}")
    ...
    def state_info_to_state(cls, state_info: Dict[str, Any]) -> State:
        ...
        for key, val in state_info.items():
            ...
            state_dict[obj] = {
                    ...
                    "y": pos_val[1],
                    "z": pos_val[2],
                    "qx": val[0], # these are now euler angles, bad bad! Online it will error since online state info are generated by environment live.
                    "qy": val[1],
                    "qz": val[2],
                }
    ...
    def _InContact_holds(self, objects: Sequence[Object]) -> bool:
        ...
        # Get the geom names for the objects
        # This assumes objects have a name attribute that matches their geom names
        # Use robosuite's check_contact function
        return self._env.check_contact(obj1, obj2)
    # @classmethod
