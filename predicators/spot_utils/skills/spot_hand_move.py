...
def move_hand_to_relative_pose(
    ...
    arm_cmd = RobotCommandBuilder.arm_pose_command(
        body_tform_goal.x, body_tform_goal.y, body_tform_goal.z, body_tform_goal.rot.w,
        body_tform_goal.rot.x, body_tform_goal.rot.y, body_tform_goal.rot.z,
        BODY_FRAME_NAME, timeout)
...
if __name__ == "__main__":
    ...
    def _run_manual_test() -> None:
        ...
        print("Moving to a resting pose.")
