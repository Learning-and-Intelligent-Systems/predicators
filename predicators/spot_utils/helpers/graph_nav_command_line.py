...
class GraphNavInterface(object):
    ...
    def __init__(self, robot, upload_path, lease_client, lease_keepalive):
        ...
        self._command_dictionary = {
            '1': self._set_initial_localization_fiducial,
            '2': self._get_localization_state,
            '3': self._list_graph_waypoint_and_edge_ids,
            '4': self._navigate_to
        }
    ...
    def _upload_graph_and_snapshots(self, *args):
        ...
        with open(self._upload_filepath + "/graph", "rb") as graph_file:
            ...
            print("Loaded graph has {} waypoints and {} edges".format(len(self._current_graph.waypoints),
    ...
    def _navigate_to_anchor(self, *args):
        ...
        while not is_finished:
            ...
            try:
                nav_to_cmd_id = self._graph_nav_client.navigate_to_anchor(seed_T_goal.to_proto(),
                                                                          1.0,
    ...
    def run(self):
        ...
        while True:
            print("""
            Options:
            (1) Initialize localization to the nearest fiducial (must be in sight of a fiducial).
            (2) Get localization state.
            (3) List the waypoint ids and edge ids of the map on the robot.
