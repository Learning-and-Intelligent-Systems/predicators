...
def _run_pipeline(env: BaseEnv,
    ...
    if cogman.is_learning_based:
        ...
        for i in range(CFG.num_online_learning_cycles):
            ...
            if (not CFG.load_approach or CFG.restart_learning) and not CFG.random_bridge and (CFG.approach != "rl_bridge_policy"  or any(["bridge" in x for x in cogman._approach._policy_logs])):
                learning_start = time.perf_counter()
