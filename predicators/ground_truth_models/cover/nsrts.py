...
class CoverGroundTruthNSRTFactory(GroundTruthNSRTFactory):
    ...
    def get_env_names(cls) -> Set[str]:
        return {
            ...
            "cover_handempty", "bumpy_cover", "regional_bumpy_cover"
        }
    ...
    def get_nsrts(env_name: str, types: Dict[str, Type],
        ...
        if env_name in ("cover", "pybullet_cover", "cover_hierarchical_types",
            ...
            PickPlace = options["PickPlace"]
                          ...
                          "bumpy_cover", "regional_bumpy_cover"):
            Pick, Place = options["Pick"], options["Place"]
        if env_name == "regional_bumpy_cover":
        ...
        if env_name in ("cover", "pybullet_cover", "cover_hierarchical_types",
            ...
            option = PickPlace
            option_vars = []
        elif env_name in ("bumpy_cover", "regional_bumpy_cover"):
            option = Pick
            option_vars = [block]
        ...
        if env_name in ("cover_regrasp", "bumpy_cover", "regional_bumpy_cover"):
        ...
        if env_name == "cover_multistep_options":
            ...
            def place_sampler(state: State, goal: Set[GroundAtom],
                ...
                if env_name in ("bumpy_cover", "regional_bumpy_cover"):
        ...
        if env_name == "regional_bumpy_cover":
            ...
            # TODO: need to add NotInBumpyRegion so that we're forced to use
            # the PickFromBumpy NSRT specifically. Otherwise we'll never see it.
            ...
            place_on_bumpy_nsrt = NSRT("PlaceOnBumpy", parameters,
                                       preconditions, add_effects,
                                       delete_effects, set(), option,
                                       option_vars, place_on_bumpy_sampler)
