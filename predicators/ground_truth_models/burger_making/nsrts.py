"""Ground-truth NSRTs for the burger making environment."""
...
class BurgerMakingGroundTruthNSRTFactory(GroundTruthNSRTFactory):
    """Ground-truth NSRTs for the burger_making environment."""
