...
def get_scaled_default_font(draw: ImageDraw.Draw,
    ...
    temp_img = PIL.Image.new("RGBA", (1, 1))
    ...
    return base_font.font_variant(size=int(scale_factor * base_font.size))


def add_text_to_draw_img(draw: ImageDraw.Draw, position: Tuple[int,
                                                               int], text: str,
                         font: ImageFont.FreeTypeFont) -> ImageDraw.Draw:
    """Method that adds some text with a particular font at a particular pixel
    position in an input PIL.ImageDraw.Draw image.

    Returns the modified ImageDraw.Draw with the added text.
    """
