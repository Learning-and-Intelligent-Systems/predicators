...
from typing import (Callable, Collection, Dict, FrozenSet, List, Sequence, Set,
                    Tuple)
...
from predicators.src.structs import (DummyOption, GroundAtom,
                                     GroundAtomTrajectory, Object, OptionSpec,
