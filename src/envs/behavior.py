...
class BehaviorEnv(BaseEnv):
    ...
    def _get_task_goal(self) -> Set[GroundAtom]:
        ...
        try:
            ...
            # Quick fix for running experiments, will just take first goal
            # option
            # TODO (wmcclinton) Fix this
            self.igibson_behavior_env.task.ground_goal_state_options = [
                self.igibson_behavior_env.task.ground_goal_state_options[0]
            ]
