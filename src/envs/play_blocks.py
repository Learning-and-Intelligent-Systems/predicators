...
class PlayBlocksEnv(BaseEnv):
    ...
    colors: ClassVar[List[str]] = ["red", "blue", "yellow"]
    train_colors: ClassVar[List[str]] = ["red", "yellow"]
    test_colors: ClassVar[List[str]] = ["red", "blue"]
    ...
    def _generate_train_tasks(self) -> List[Task]:
        # NOTE: Generate demos from the TEST distribution.
