...
from predicators.src.approaches import ApproachFailure, ApproachTimeout, \
    BaseApproach
from predicators.src.option_model import create_option_model, _OptionModelBase
...
class BilevelPlanningApproach(BaseApproach):
    ...
    def get_option_model(self) -> _OptionModelBase:
        """For ONLY an oracle approach or BEHAVIOR, we allow the user
        to get the current option model."""
        return self._option_model

    def get_last_plan(self) -> List[_Option]:
        """For ONLY BEHAVIOR, we allow the user to get the plan that
