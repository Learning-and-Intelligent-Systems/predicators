...
class BilevelPlanningApproach(BaseApproach):
    ...
    def _solve(self, task: Task, timeout: int) -> Callable[[State], Action]:
        ...
        plan, metrics, traj = self._run_sesame_plan(task, nsrts, preds, timeout,
                                              seed)
    ...
    def get_last_traj(self) -> List[_Option]:
        """For ONLY BEHAVIOR, we allow the user to get the trajectory that was most
        recently generated by a call to solve().
